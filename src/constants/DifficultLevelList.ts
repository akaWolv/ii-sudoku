...
const DifficultyLevelList: DifficultyLevel[] = [
  { level: 1, key: 'easy', staticTiles: 38, tilesPerSquare: [5,5,4,4,4,4,4,4,4], text: 'easy', isDefault: true },
  { level: 2, key: 'medium', staticTiles: 32, tilesPerSquare: [5,4,4,4,3,3,3,3,3], text: 'medium' },
